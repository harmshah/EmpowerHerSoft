      ...
      <section className="about-section slide-in-left">
        ...
        <div className="section-content">
          ...
          <p style={{textAlign: "left"}}>
            ...
            Because to be a woman is to walk through life with bothburdens and brilliance.
            It is the grace to begin again, and the wisdom to lead others asyou rise.
      ...
      <section className="about-section slide-in-left">
        ...
        <div className="section-content">
          ...
          <p style={{textAlign: "left"}}>
            ...
            Here, women are seen, heard, and honored exactly as they are. Whether entering the workforce, returning after a pause, reinventing a career, or building a dream from scratch, she belongs here.
            We don’t push women to fit timelines or titles. We help them pause, reflect, and move forward on their own terms, with intention, not pressure.
            Because true empowerment isn’t about telling women what to do. It’s about reminding them: You already know. You already can. You never needed permission.
      ...
      <section className="about-section slide-in-right">
        ...
        <div className="section-content">
          ...
          <p style={{textAlign: "left"}}>
            ...
            And we won’t stop until no woman is left behind. 
            Because When a woman shines by her own light, the whole world becomes brighter.
          </p>
        </div>
      </section>
    </div>
