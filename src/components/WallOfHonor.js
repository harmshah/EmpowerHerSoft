  ...
  return (
    <div className="honor-wrapper">
      ...
      <div className="form-container animated slideInUp">
        <h2 className="form-title">Empower Her Soft - Wall of Honor Nomination</h2>
        ...
        <form className="nomination-form" onSubmit={handleSubmit}>
          ...
          <input type="text" name="honoreeName" value={formData.honoreeName} onChange={handleChange} required />
          ...
          <textarea name="story" rows="5" value={formData.story} onChange={handleChange} required />

          <label>One word that describes her:</label>
          <input type="text" name="descriptionWord" value={formData.descriptionWord} onChange={handleChange} />

          <label>Share her name on our Wall? (Yes/No):</label>
          <input type="text" name="shareConsent" value={formData.shareConsent} onChange={handleChange} />
